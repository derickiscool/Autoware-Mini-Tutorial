...
class SimpleSpeedPlanner:
    ...
    def collision_points_and_path_callback(self, collision_points_msg, local_path_msg):
        try:
            ...
            min_index = np.argmin(calculated_target_velocities)
            target_velocity = calculated_target_velocities[min_index]

            target_object_distance = collision_point_distances[min_index] - self.distance_to_car_front
            target_object_speed = collision_point_speeds[min_index]
            collision_point_braking_distance = collision_point_braking_distances[min_index]
            collision_point_category = collision_points[min_index]["category"]
            stopping_point_distance = collision_point_distances[min_index] - collision_point_braking_distance
